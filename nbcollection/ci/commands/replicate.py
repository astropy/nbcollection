...
EXAMPLE_USAGE = """Example Usage:
    ...
    Source Example:
    python -m nbcollection.ci replicate -r https://github.com/spacetelescope/dat_pyinthesky/pull/122 -p /tmp/repo
"""
...
def convert(args=None):
    ...
    parser = argparse.ArgumentParser(prog='nbcollection-ci replicate',
