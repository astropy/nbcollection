...
def test__select_repo_type__Local(repo_local_path: str) -> None:
    import git
    import os
    import tempfile
    ...
    repo_path, repo_type = select_repo_type(repo_local_path)
    assert repo_type is RepoType.Local
...
def test__select_repo_type__Github_https_url(repo_https_url: str) -> None:
    ...
    repo_path, repo_type = select_repo_type(repo_https_url)
    assert not os.path.exists(repo_path)
    assert repo_type is RepoType.GithubHTTPS
