...
EXAMPLE_USAGE = """Example Usage:
    ...
    nbcollection-ci metadata -m reset-notebooks --notebook-category asdf_example --notebook-collection jdat_notebooks

    Install machinery locally:
    nbcollection-ci metadata -m extract-metadata --notebook-category asdf_example --notebook-collection jdat_notebooks
"""
